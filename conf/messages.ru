...
leader.subscribe.request_invite=Получить приглашение
...
reports.bullet_one.description=Используйте Instabank для покупок или оплаты услуг. Мгновенно получайте уведомления и наглядные записи о совершенных действиях в ленте событий.
...
reports.bullet_three.description=Instabank автоматически сортирует ваши траты по категориям и показывает, куда уходят деньги, с помощью простых диаграмм. Находите покупки и переводы при помощи запросов, таких как “Театр” или “Starbucks”.
...
# Tariffs section
tariffs=тарифы
tariffs.title=О наших <span>тарифах</span>
